  ...
  async function deleteAccount() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setError(d.error || 'Error deleting account. Please contact support at support@bgready.site');
        return;
      }
      await supabase.auth.signOut();
      router.push('/');
    } catch {
      setError('Error deleting account. Please contact support at support@bgready.site');
    } finally {
      setDeleting(false);
    }
  }
