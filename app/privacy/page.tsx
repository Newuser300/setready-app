...
export default function PrivacyPolicyPage() {
  return (
    <main style={wrap}>
      ...
      <p style={p}>To exercise these rights, contact us at <a style={a} href="mailto:privacy@setready.site">privacy@setready.site</a>. We will respond within the timeframes required by law.</p>
      ...
      <p style={p}>
        ...
        your account settings, or contact us at <a style={a} href="mailto:privacy@setready.site">privacy@setready.site</a> and we will correct it promptly.
      </p>
      ...
      <p style={p}>
        ...
        reach the Privacy Officer at <a style={a} href="mailto:privacy@setready.site">privacy@setready.site</a>.
      </p>
      ...
      <p style={p}>
        Questions, or to exercise your rights: <a style={a} href="mailto:privacy@setready.site">privacy@setready.site</a>.
      </p>
