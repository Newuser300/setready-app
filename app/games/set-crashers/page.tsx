...
const PROJECTILES: Record<string, ProjDef> = {
  ...
  coffee:    { emoji: '☕', name: 'Hot Coffee',    r: 22, density: 0.004, power: 'explode',   desc: 'Tap mid-flight — explodes with a blast radius.', color: '#7c3f1d' },
  ...
  bomb:      { emoji: '💣', name: 'Bomb',          r: 22, density: 0.005, power: 'bomb',      desc: 'Tap to detonate a huge blast (or it blows on landing).', color: '#111827', free: true },
...
const LEVELS: Level[] = [
  { name: 'First Take', pack: 'free', ammo: 5, par: 1, blocks: [
    { x: 820, y: 610, w: 40, h: 100, kind: 'plank' },
    { x: 940, y: 610, w: 40, h: 100, kind: 'plank' },
    { x: 880, y: 548, w: 170, h: 28, kind: 'plank' },
    { x: 880, y: 510, w: 46, h: 46, kind: 'target' },
  ]},
  { name: 'Stack Attack', pack: 'free', ammo: 5, par: 2, blocks: [
    { x: 870, y: 632, w: 52, h: 52, kind: 'crate' },
    { x: 870, y: 578, w: 52, h: 52, kind: 'crate' },
    { x: 870, y: 526, w: 46, h: 46, kind: 'target' },
    { x: 1000, y: 632, w: 52, h: 52, kind: 'crate' },
    { x: 1000, y: 578, w: 46, h: 46, kind: 'target' },
  ]},
  { name: 'Top Heavy', pack: 'free', ammo: 5, par: 2, blocks: [
    { x: 800, y: 608, w: 40, h: 104, kind: 'plank' },
    { x: 1000, y: 608, w: 40, h: 104, kind: 'plank' },
    { x: 900, y: 544, w: 250, h: 28, kind: 'plank' },
    { x: 850, y: 504, w: 52, h: 52, kind: 'crate' },
    { x: 950, y: 504, w: 52, h: 52, kind: 'crate' },
    { x: 900, y: 484, w: 46, h: 46, kind: 'target' },
  ]},
  { name: 'The Tower', pack: 'free', ammo: 5, par: 2, blocks: [
    { x: 900, y: 628, w: 62, h: 62, kind: 'rig' },
    { x: 900, y: 566, w: 52, h: 52, kind: 'crate' },
    { x: 900, y: 514, w: 52, h: 52, kind: 'crate' },
    { x: 900, y: 466, w: 46, h: 46, kind: 'target' },
    { x: 1070, y: 632, w: 46, h: 46, kind: 'target' },
  ]},
  { name: 'Double Trouble', pack: 'free', ammo: 5, par: 3, blocks: [
    { x: 760, y: 608, w: 40, h: 104, kind: 'plank' },
    { x: 860, y: 608, w: 40, h: 104, kind: 'plank' },
    { x: 810, y: 544, w: 150, h: 26, kind: 'plank' },
    { x: 810, y: 508, w: 46, h: 46, kind: 'target' },
    { x: 1010, y: 608, w: 40, h: 104, kind: 'plank' },
    { x: 1110, y: 608, w: 40, h: 104, kind: 'plank' },
    { x: 1060, y: 544, w: 150, h: 26, kind: 'plank' },
    { x: 1060, y: 508, w: 46, h: 46, kind: 'target' },
  ]},
  { name: 'Fortress', pack: 'free', ammo: 5, par: 3, blocks: [
    { x: 850, y: 628, w: 62, h: 62, kind: 'rig' },
    { x: 1010, y: 628, w: 62, h: 62, kind: 'rig' },
    { x: 930, y: 628, w: 62, h: 62, kind: 'rig' },
    { x: 930, y: 566, w: 250, h: 30, kind: 'plank' },
    { x: 870, y: 522, w: 52, h: 52, kind: 'crate' },
    { x: 990, y: 522, w: 52, h: 52, kind: 'crate' },
    { x: 930, y: 516, w: 46, h: 46, kind: 'target' },
    { x: 930, y: 470, w: 46, h: 46, kind: 'target' },
  ]},
  { name: 'Pyramid', pack: 'free', ammo: 5, par: 3, blocks: [
    { x: 840, y: 632, w: 52, h: 52, kind: 'crate' },
    { x: 898, y: 632, w: 52, h: 52, kind: 'crate' },
    { x: 956, y: 632, w: 52, h: 52, kind: 'crate' },
    { x: 1014, y: 632, w: 52, h: 52, kind: 'crate' },
    { x: 869, y: 578, w: 52, h: 52, kind: 'crate' },
    { x: 927, y: 578, w: 46, h: 46, kind: 'target' },
    { x: 985, y: 578, w: 52, h: 52, kind: 'crate' },
    { x: 927, y: 526, w: 46, h: 46, kind: 'target' },
  ]},
  { name: "That's a Wrap", pack: 'free', ammo: 5, par: 3, blocks: [
    { x: 780, y: 608, w: 40, h: 104, kind: 'plank' },
    { x: 880, y: 608, w: 40, h: 104, kind: 'plank' },
    { x: 830, y: 544, w: 150, h: 26, kind: 'plank' },
    { x: 830, y: 508, w: 46, h: 46, kind: 'target' },
    { x: 980, y: 628, w: 62, h: 62, kind: 'rig' },
    { x: 980, y: 566, w: 52, h: 52, kind: 'crate' },
    { x: 980, y: 514, w: 46, h: 46, kind: 'target' },
    { x: 1120, y: 632, w: 52, h: 52, kind: 'crate' },
    { x: 1120, y: 578, w: 46, h: 46, kind: 'target' },
  ]},
  // ---- additional free levels ----
  { name: 'Balancing Act', pack: 'free', ammo: 5, par: 2, blocks: [
    { x: 920, y: 620, w: 36, h: 80, kind: 'rig' },
    { x: 920, y: 560, w: 220, h: 24, kind: 'plank' },
    { x: 840, y: 524, w: 46, h: 46, kind: 'target' },
    { x: 1000, y: 524, w: 46, h: 46, kind: 'target' },
  ]},
  { name: 'Watchtower', pack: 'free', ammo: 5, par: 3, blocks: [
    { x: 950, y: 628, w: 62, h: 62, kind: 'rig' },
    { x: 950, y: 566, w: 56, h: 56, kind: 'crate' },
    { x: 950, y: 512, w: 52, h: 52, kind: 'crate' },
    { x: 950, y: 462, w: 48, h: 48, kind: 'crate' },
    { x: 950, y: 416, w: 46, h: 46, kind: 'target' },
    { x: 820, y: 632, w: 46, h: 46, kind: 'target' },
  ]},
  { name: 'Crossfire', pack: 'free', ammo: 5, par: 3, blocks: [
    { x: 780, y: 632, w: 52, h: 52, kind: 'crate' },
    { x: 780, y: 580, w: 46, h: 46, kind: 'target' },
    { x: 960, y: 608, w: 40, h: 104, kind: 'plank' },
    { x: 1080, y: 608, w: 40, h: 104, kind: 'plank' },
    { x: 1020, y: 544, w: 150, h: 26, kind: 'plank' },
    { x: 1020, y: 508, w: 46, h: 46, kind: 'target' },
    { x: 1020, y: 462, w: 52, h: 52, kind: 'rig' },
  ]},
  { name: 'The Wall', pack: 'free', ammo: 5, par: 3, blocks: [
    { x: 880, y: 632, w: 56, h: 56, kind: 'rig' },
    { x: 880, y: 578, w: 56, h: 56, kind: 'rig' },
    { x: 880, y: 526, w: 52, h: 52, kind: 'crate' },
    { x: 880, y: 476, w: 46, h: 46, kind: 'target' },
    { x: 1010, y: 632, w: 52, h: 52, kind: 'crate' },
    { x: 1010, y: 580, w: 46, h: 46, kind: 'target' },
    { x: 1130, y: 632, w: 46, h: 46, kind: 'target' },
  ]},
  ...Array.from({ length: 12 }, (_, i): Level => ({
    name: `Studio Lot ${i + 1}`, pack: 'studio', ammo: 5, par: 3,
    blocks: [
      { x: 830, y: 628, w: 62, h: 62, kind: 'rig' },
      { x: 990, y: 628, w: 62, h: 62, kind: 'rig' },
      { x: 910, y: 566, w: 230, h: 28, kind: 'plank' },
      { x: 870, y: 522, w: 52, h: 52, kind: 'crate' },
      { x: 950, y: 522, w: 52, h: 52, kind: 'crate' },
      { x: 910, y: 514, w: 46, h: 46, kind: 'target' },
      { x: 910, y: 468, w: 46, h: 46, kind: 'target' },
      ...(i % 2 ? [{ x: 1130, y: 632, w: 46, h: 46, kind: 'target' as const }] : []),
    ],
  })),
];

type SaveData = { stars: Record<number, number>; owned: string[]; hints: number; skips: number; lastUnlocked: number; bonusBest: number };
const DEFAULT_SAVE: SaveData = { stars: {}, owned: [], hints: 1, skips: 0, lastUnlocked: 0, bonusBest: 0 };
function loadSave(): SaveData {
  try { const raw = localStorage.getItem(SAVE_KEY); if (raw) return { ...DEFAULT_SAVE, ...JSON.parse(raw) }; } catch {}
  return { ...DEFAULT_SAVE };
}
...
export default function SetCrashers() {
  ...
  const g = useRef<{
    ...
    settleT: number; last: number; launchDir: number; projKind: string;
    drops: Drop[]; dropTimer: number; bonusT: number; bonusCaught: Record<string, number>; bonusEnded: boolean;
  }>({ engine: null, raf: 0, mode: 'level', bodies: [], targets: [], projectile: null, flying: false, extra: [], aiming: false, aimX: 0, aimY: 0, particles: [], shake: 0, ammo: 0, armed: false, loadGuard: 0, ended: false, powerUsed: false, settleT: 0, last: 0, launchDir: 1, projKind: 'clapper', drops: [], dropTimer: 6, bonusT: 15, bonusCaught: {}, bonusEnded: false });

  const saveRef = useRef(save); saveRef.current = save;
  const selRef = useRef(selProj); selRef.current = selProj;
  const hintRef = useRef(hintActive); hintRef.current = hintActive;
  const lvlRef = useRef(levelIdx); lvlRef.current = levelIdx;
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await fetch('/api/game-purchases'); const data = await res.json();
        if (data && Array.isArray(data.items)) setSave(prev => { const n = { ...prev, owned: Array.from(new Set([...prev.owned, ...data.items])) }; persist(n); return n; });
  ...
  const projUnlocked = (k: string) => k === FREE_PROJECTILE || owns(`proj_${k}`);
  const studioUnlocked = () => owns('pack_studio');

  const grantProjectile = (key: string) => {
    if (owns(`proj_${key}`)) return false;
    setSave(prev => { const n = { ...prev, owned: Array.from(new Set([...prev.owned, `proj_${key}`])) }; persist(n); return n; });
    return true;
  };
  ...
  const buildArena = useCallback((idx: number, m: Mode) => {
    ...
    if (m === 'level') {
      ...
      for (const b of lvl.blocks) {
        ...
        body.crasherKind = b.kind; body.crasherHP = isT ? 100 : 0; body.crasherAlive = true; body.crasherStartY = b.y;
    ...
    G.ended = false; G.powerUsed = false; G.settleT = 0; G.drops = []; G.dropTimer = m === 'bonus' ? 0.3 : 6;
  ...
  const spawnDrop = (forBonus: boolean) => {
    ...
    // bias: projectiles rarer & only if not yet owned
    const lockedProjs = PROJ_EMOJIS.filter(k => !owns(`proj_${k}`));
    if (lockedProjs.length && roll < (forBonus ? 0.4 : 0.5)) {
      kind = 'proj'; projKey = lockedProjs[Math.floor(Math.random() * lockedProjs.length)]; emoji = PROJECTILES[projKey].emoji;
  ...
  const catchDrop = (d: Drop) => {
    ...
    if (G.mode === 'bonus') {
      ...
      if (d.kind === 'proj' && d.projKey) grantProjectile(d.projKey);
      else if (d.kind === 'hint') addHints(1);
      else addSkips(1);
    } else {
      if (d.kind === 'proj' && d.projKey) { if (grantProjectile(d.projKey)) toast(`🎁 Unlocked ${PROJECTILES[d.projKey].name}!`); else { addHints(1); toast('🎁 +1 Hint'); } }
  ...
  const triggerPower = () => {
    ...
    if (def.power === 'explode') { explodeAt(p.position.x, p.position.y, 200, 0.6); Matter.Composite.remove(G.engine.world, p); G.projectile = null; G.flying = false; setTimeout(() => settleCheck(), 600); }
      ...
      const count = def.power === 'multi' ? 4 : 2;
      spawnParticles(p.position.x, p.position.y, 18, '#cbd5e1', 220);
      for (let i = 1; i <= count; i++) {
        const off = (i - count / 2) * 5;
        const c = Matter.Bodies.circle(p.position.x, p.position.y, def.r * 0.7, { density: def.density * 0.6, restitution: 0.3, friction: 0.4, label: 'proj' });
        Matter.Body.setVelocity(c, { x: p.velocity.x, y: p.velocity.y + off });
  ...
  const finish = useCallback((won: boolean) => {
    ...
    setTimeout(() => {
      ...
      if (won) setSave(prev => {
        ...
        // star-milestone projectile unlocks
        const total = Object.values(n.stars).reduce((a, b) => a + b, 0);
        for (const ms of STAR_MILESTONES) if (total >= ms.stars && !n.owned.includes(`proj_${ms.key}`)) n.owned = [...n.owned, `proj_${ms.key}`];
        persist(n); return n;
      });
    }, won ? 500 : 800);
  }, [persist]);
  ...
  useEffect(() => {
    ...
    const loop = (now: number) => {
      ...
      if (G.engine) {
        ...
        // boomerang curve (continuous reverse-thrust) while flying — validated to arc back
        if (G.flying && G.projectile && G.projKind === 'boomerang') {
          const p = G.projectile; const v = p.velocity;
          Matter.Body.setVelocity(p, { x: v.x - G.launchDir * 0.15, y: v.y });
        }
        ...
        if (p && G.flying) {
          ...
          if (off || sp < 1.2) {
            G.settleT += dt;
            if (G.settleT > 0.6 || off) {
              // bomb auto-detonates on settle if not used
              if (!off && G.projKind === 'bomb' && !G.powerUsed) { G.powerUsed = true; explodeAt(p.position.x, p.position.y, 260, 0.85); }
              Matter.Composite.remove(G.engine.world, p); G.projectile = null; G.flying = false; G.settleT = 0;
              if (G.mode === 'level') setTimeout(() => settleCheck(), 250);
            }
          } else G.settleT = 0;
        }
        // clean up extras that fell away
        G.extra = G.extra.filter(e => { const gone = e.position.y > WORLD_H + 200 || e.position.x > WORLD_W + 200 || e.position.x < -200; if (gone) Matter.Composite.remove(G.engine.world, e); return !gone; });

        // detect downed targets (level only, armed): off-screen, OR knocked off its perch
        // and come to rest well below where it started, OR resting on the ground.
        if (G.mode === 'level' && G.armed && G.loadGuard <= 0.001) {
          for (const t of [...G.targets]) {
            const offscreen = t.position.y > WORLD_H + 100 || t.position.x < -100 || t.position.x > WORLD_W + 150;
            const sp = Math.hypot(t.velocity.x, t.velocity.y) + Math.abs(t.angularVelocity) * 30;
            const startY = t.crasherStartY ?? t.position.y;
            const knockedDown = sp < 1.5 && (t.position.y - startY) > 70; // fell 70px+ and stopped
            const onGround = sp < 1.5 && t.position.y > GROUND_Y - 36 && (t.position.y - startY) > 30; // settled on the floor below start
            if (offscreen || knockedDown || onGround) destroyTarget(t);
          }
        }
  ...
  const draw = (ctx: CanvasRenderingContext2D, canvas: HTMLCanvasElement) => {
    ...
    if (G.projectile) drawProj(ctx, G.projectile.position.x, G.projectile.position.y, G.projectile.angle);
    for (const e of G.extra) drawProj(ctx, e.position.x, e.position.y, e.angle);
  ...
  const drawProj = (ctx: CanvasRenderingContext2D, x: number, y: number, angle: number) => {
    const def = PROJECTILES[selRef.current]; ctx.save(); ctx.translate(x, y); ctx.rotate(angle);
    ...
    ctx.fillStyle = grad; ctx.beginPath(); ctx.arc(0, 0, def.r, 0, Math.PI * 2); ctx.fill();
    ctx.shadowBlur = 0; ctx.font = `${def.r * 1.3}px serif`; ctx.textAlign = 'center'; ctx.textBaseline = 'middle'; ctx.fillText(def.emoji, 0, 1); ctx.restore();
  };
  ...
  const onUp = (e: React.PointerEvent) => {
    ...
    const vx = dx * LAUNCH_SCALE, vy = dy * LAUNCH_SCALE;
    Matter.Body.setVelocity(proj, { x: vx, y: vy });
    G.projectile = proj; G.flying = true; G.powerUsed = false; G.settleT = 0; G.armed = true; G.launchDir = vx >= 0 ? 1 : -1; G.projKind = key;
    if (G.mode === 'level') { G.ammo--; setAmmoLeft(G.ammo); }
        ...
        <div style={{ maxWidth: '760px', margin: '0 auto', padding: '20px 16px 48px' }}>
          ...
          <div style={{ ...card, marginTop: '12px', padding: '14px 16px' }}>
            ...
            {showHow && (<div style={{ marginTop: '10px', fontSize: '13px', color: '#4b5563', lineHeight: 1.6 }}>
              <p style={{ margin: '0 0 8px' }}><strong>Goal:</strong> clear every ⭐ target on the level. The 🎬 counter shows shots left.</p>
              <p style={{ margin: '0 0 8px' }}><strong>Aim &amp; fire:</strong> press and hold on the slingshot, drag <em>backward</em> (away from the stacks); a dotted arc previews the shot. Pull further for more power (watch the green/red bar). Release to launch.</p>
              ...
              <p style={{ margin: '0 0 8px', paddingLeft: '12px' }}>② <strong>Knock it down:</strong> topple its support so the ⭐ falls off its perch. Once it lands on the ground (or tumbles off the screen) it counts as cleared — you don&apos;t have to hit it directly.</p>
              <p style={{ margin: '0 0 8px' }}><strong>Use the structure:</strong> a powerful shot can fling heavy crates and beams into targets you can&apos;t reach directly.</p>
              <p style={{ margin: '0 0 8px' }}><strong>Power-up ammo:</strong> pick a projectile below to equip it. After launching, <strong>tap anywhere while it&apos;s flying</strong> to trigger its power — ☕ explodes, 🎤 dives to smash, 🎞️/🎭 split, 💣 detonates. 🪃 curves back on its own (no tap). Time the tap right next to a target.</p>
              <p style={{ margin: '0 0 8px' }}><strong>Prize drops 🎁:</strong> parachuting prizes fall during play — hit one with your shot to grab it (new projectiles, hints, skips). Miss it and it&apos;s gone.</p>
              <p style={{ margin: '0 0 8px' }}><strong>Bonus round:</strong> 15 seconds of nonstop prize drops — shoot as many as you can and keep them all.</p>
              <p style={{ margin: 0 }}><strong>Stars:</strong> finish at/under par for 3★, one over for 2★, else 1★. 💡 Hint shows an arc; ⏭️ Skip jumps ahead keeping 1★.</p>
            </div>)}
          </div>

          <div style={{ marginTop: '18px', fontWeight: 800, fontSize: '14px', color: '#e5e7eb' }}>Your Ammo</div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '8px', marginTop: '8px' }}>
            {Object.entries(PROJECTILES).map(([key, def]) => { const unlocked = projUnlocked(key); const sel = selProj === key; const isFree = !!def.free; return (
              <button key={key} onClick={() => unlocked ? setSelProj(key) : (isFree ? toast(`Catch a ${def.emoji} prize drop or reach a star milestone to unlock ${def.name}!`) : buyItem(`proj_${key}`))} style={{ ...card, padding: '10px 6px', textAlign: 'center', cursor: 'pointer', border: sel ? '2px solid #F59E0B' : '1px solid #e5e7eb', opacity: unlocked ? 1 : 0.6 }}>
                <div style={{ fontSize: '26px' }}>{def.emoji}</div><div style={{ fontSize: '10px', fontWeight: 700, color: '#374151', marginTop: '2px' }}>{def.name}</div>
                {!unlocked && <div style={{ fontSize: '9px', color: isFree ? '#7c3aed' : '#F59E0B', fontWeight: 800, marginTop: '2px' }}>{isFree ? '🎁 Earn' : '🔒 Buy'}</div>}{sel && <div style={{ fontSize: '9px', color: '#16a34a', fontWeight: 800, marginTop: '2px' }}>✓ Equipped</div>}
              </button>); })}
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {STORE.map(it => { const ownedAlready = (it.kind === 'pack' || it.kind === 'proj') && owns(it.id); return (
              <div key={it.id} style={{ ...card, padding: '12px 14px', display: 'flex', alignItems: 'center', gap: '12px' }}>
                <span style={{ fontSize: '24px' }}>{it.emoji}</span>
                <div style={{ flex: 1 }}><div style={{ fontWeight: 700, fontSize: '14px', color: '#1a1a2e' }}>{it.name}</div><div style={{ fontSize: '12px', color: '#6b7280' }}>{it.desc}</div></div>
                {ownedAlready ? <span style={{ fontSize: '12px', fontWeight: 800, color: '#16a34a' }}>✓ Owned</span> : <button onClick={() => buyItem(it.id)} style={{ backgroundColor: '#1a1a2e', color: 'white', border: 'none', borderRadius: '10px', padding: '9px 14px', fontWeight: 800, fontSize: '13px', cursor: 'pointer', whiteSpace: 'nowrap' }}>{it.price}</button>}
              </div>); })}
          </div>
          <Copyright />
        </div>
      ...
      {screen === 'play' && (
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '12px 12px 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '6px', marginTop: '8px', justifyContent: 'center', flexWrap: 'wrap' }}>
            {Object.entries(PROJECTILES).map(([key, def]) => { const unlocked = projUnlocked(key); const sel = selProj === key; return (
              <button key={key} onClick={() => { if (!unlocked) { if (def.free) toast(`Catch a ${def.emoji} prize drop to unlock ${def.name}!`); else buyItem(`proj_${key}`); return; } if (!g.current.flying) setSelProj(key); }} title={def.name} style={{ width: '44px', height: '44px', borderRadius: '10px', border: sel ? '2px solid #F59E0B' : '1px solid #374151', backgroundColor: sel ? 'rgba(245,158,11,0.15)' : '#1a1a2e', fontSize: '22px', cursor: 'pointer', opacity: unlocked ? 1 : 0.5, position: 'relative' }}>
                {def.emoji}{!unlocked && <span style={{ position: 'absolute', top: '-4px', right: '-4px', fontSize: '10px' }}>{def.free ? '🎁' : '🔒'}</span>}
              </button>); })}
          </div>
