                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '12px' }}>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    {message.priority === 'urgent' && (
                      <span style={{ marginLeft: '6px', fontSize: '11px', fontWeight: '700', padding: '2px 8px', borderRadius: '999px', backgroundColor: '#dc2626', color: 'white' }}>
                        🚨 URGENT
                      </span>
                    )}
                    {message.priority === 'high' && (
                      <span style={{ marginLeft: '6px', fontSize: '11px', fontWeight: '700', padding: '2px 8px', borderRadius: '999px', backgroundColor: '#f59e0b', color: '#1a1a2e' }}>
                        ⚡ IMPORTANT
                      </span>
                    )}
          ...
          >
            ...
            <div style={{ marginBottom: '12px' }}>
              <span style={{
                ...
                padding: '3px 10px',
                borderRadius: '999px',
                backgroundColor: TYPE_COLORS[selectedMessage.message_type] || '#6b7280',
                color: 'white',
              }}>
