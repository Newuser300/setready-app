...
export default function SignUpModal({ onClose }: SignUpModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal card */}
      <div className="relative bg-[#1A1A1A] rounded-2xl max-w-md w-full shadow-2xl animate-modal-in overflow-hidden">
        {/* Gold accent bar */}
        ...
        <div className="px-8 pb-8 pt-6">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full py-3.5 bg-transparent text-white border border-white/20 font-semibold rounded-xl hover:bg-white/5 transition-all duration-200 text-base"
            >
          ...
          <div className="text-center space-y-1.5">
            <p className="text-gray-400 text-sm">
              ...
              {'  •  '}
              Section 2:{' '}
              <span className="text-white font-medium">$19.99 once</span>
            </p>
