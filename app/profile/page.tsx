...
const TRAINING_OPTS = ['No formal training','On-set experience only','Acting classes (ongoing)','Acting school / conservatory','University / college theatre program','BGReady training modules','Commercial acting classes','Voice training','Improv classes','Stunt training','Dance training','Singing lessons']
